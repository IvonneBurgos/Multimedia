<?php
    ...
    //pasando parametros de entrada que seran pasados hacia el metodo
        ...
        $resultado = $client->call('modificaAntecedente', array('id_antecedente'=> $_POST['id'], 'nombre'=> $_POST['nombre'], 'id_tipo'=> $_POST['tipo'], 'id_subtipo'=> $_POST['subtipo'], 'estado'=> $_POST['estado']));
