...
require_once('../../lib/nusoap-0.9.5/lib/nusoap.php');
  ...
  $wsdl="http://appmedica.publidimas.com/sw/vista/servicio_web.php?wsdl";
        ...
        $pilamaster= [];
        $pilasuperior = [];
        $arregloCampos = ['id','cedula','nombre','apellido','fecha_nacimiento','genero','ocupacion','correo','num_hijos','ciudad','provincia','nivel_instruccion','religion','estado_civil','etnia'];
