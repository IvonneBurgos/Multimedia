 <?php
    ...
    //pasando parametros de entrada que seran pasados hacia el metodo
        ...
        $resultado = $client->call('modificaEmpleadoInstituto', array('id_empleado_instituto'=> $_POST['id'], 'id_instituto_salud'=> $_POST['id_instituto_salud'], 'id_empleado'=> $_POST['id_empleado'], 'estado'=>$_POST['estado']));
