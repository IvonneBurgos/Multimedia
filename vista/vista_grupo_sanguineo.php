...
<head>
 ...
 <link rel="stylesheet" href="../css/style.css" type="text/css"/>     
  ...
  <script src="../js/script_grupo_sanguineo.js"></script>
...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="insertar">
            ...
            <form>
                <div class="form-group">    
                    <h3>Ingresar nuevo Grupo Sanguíneo</h3>
                    <br>
                    <label>Nombre:</label><br>
                    <input id="nombre_grupo_sanguineo" class="form-control" type="text" name="nombre"><br>               
                </div>
            </form>
        ...
        <div id="presentacion">
            <h1>Panel de Administración de Grupo Sanguíneo</h1>
        </div>
        
        <div id="leer">
            <h3>Lista de Grupos Sanguíneos</h3>
            <div class="refresh">
        ...
        <div id="modificar">
            ...
            <form>
                <div class="form-group">   
                    <h3>Modificar un Grupo Sanguíneo</h3>
                    <br>
                    <label>Id:</label><br>
    ...
    <div id="eliminar">
        ...
        <form>
            <div class="form-group">  
                ...
                <h3>Eliminar Grupo Sanguíneo</h3>
                ...
                <div class="col-sm-5 text-left"> 
                    ...
                    <select id='eliminaNombreGrupoSanguineo' class="form-control"></select><br>
                    ...
                    <select id='eliminaIdGrupoSanguineo' class="form-control"></select><br>
