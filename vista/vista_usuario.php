...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="insertar">
            ...
            <form>
                <div class="form-group">    
                    ...
                    <input id="nombre_usuario" class="form-control" type="text" name="nombre"><br><br>
                    <label>Clave:</label><br>
                    <input id="clave_usuario" class="form-control" type="text" name="clave">
                </div>
            </form>
        ...
        <div id="presentacion">
            <h1>Panel de Administración de Usuario</h1>
        </div>
        ...
        <div id="modificar">
            ...
            <form>
                <div class="form-group">   
                    ...
                    <br>
                    <label>Clave:</label><br>
                    <input id="clave_usuario" class="form-control" type="text" name="clave"><br>
                    <br>
