...
<head>
 ...
 <link rel="stylesheet" href="../css/style.css" type="text/css"/>     
  ...
  <script src="../js/script_tipo_antecedente.js"></script>
...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="insertar">
            ...
            <form>
                <div class="form-group">    
                    <h3>Ingresar nuevo Tipo de Antecedente</h3>
                    <br>
                    <label>Nombre:</label><br>
                    <input id="nombre_tipo_antecedente" class="form-control" type="text" name="nombre">
                </div>
            </form>
        ...
        <div id="presentacion">
            <h1>Panel de Administración de Tipo de Antecedente</h1>
        </div>
        
        <div id="leer">
            <h3>Lista de Tipos de Antecedente</h3>
            <div class="refresh">
    ...
    <div id="eliminar">
        ...
        <form>
            <div class="form-group">  
                ...
                <h3>Eliminar Tipo de Antecedente</h3>
