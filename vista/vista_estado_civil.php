...
<head>
 ...
 <link rel="stylesheet" href="../css/style.css" type="text/css"/>     
  ...
  <script src="../js/script_estado_civil.js"></script>
...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="insertar">
            ...
            <form>
                <div class="form-group">    
                    <h3>Ingresar nuevo Estado Civil</h3>
                    <br>
                    <label>Nombre:</label><br>
                    <input id="nombre_estado_civil" class="form-control" type="text" name="nombre">
                </div>
            </form>
        ...
        <div id="presentacion">
            <h1>Panel de Administración de Estado Civil</h1>
        </div>
        
        <div id="leer">
            <h3>Lista de Estado Civil</h3>
            <div class="refresh">
        ...
        <div id="modificar">
            ...
            <form>
                <div class="form-group">   
                    <h3>Modificar un Estado Civil</h3>
                    <br>
                    <label>Id:</label><br>
                    <select class="form-control" id='idModificar'></select><br>
                    <br>
                    <label>Nombre:</label><br>
                    <input id="nombre_estado_civil" class="form-control" type="text" name="nombre"><br>
        ...
        <form>
            <div class="form-group">  
                ...
                <div class="col-sm-5 text-left"> 
                    ...
                    <select class="form-control" id='eliminaNombreEstadoCivil'></select><br>
                    <br>
                    ...
                    <select class="form-control" id='eliminaIdEstadoCivil'></select><br>
                    <br>
