...
<head>
 ...
 <link rel="stylesheet" href="../css/style.css" type="text/css"/>     
  ...
  <script src="../js/script_enfermedad.js"></script>
...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="insertar">
            ...
            <form>
                <div class="form-group">    
                    <h3>Ingresar nueva Enfermedad</h3>
                    <br>
                    <label>Nombre:</label><br>
                    <input id="nombre_enfermedad" class="form-control" type="text" name="nombre"><br>               
                </div>
            </form>
        ...
        <div id="presentacion">
            <h1>Panel de Administración de Enfermedad</h1>
        </div>
        ...
        <div id="modificar">
            ...
            <form>
                <div class="form-group">   
                    <h3>Modificar una Enfermedad</h3>
                    <br>
                    <label>Id:</label><br>
        ...
        <form>
            <div class="form-group">  
                ...
                <div class="col-sm-5 text-left"> 
                    ...
                    <select id='eliminaNombreEnfermedad' class="form-control"></select><br>
                    ...
                    <select id='eliminaIdEnfermedad' class="form-control"></select><br>
