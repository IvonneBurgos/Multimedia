...
<head>
 ...
 <link rel="stylesheet" href="../css/style.css" type="text/css"/>     
  ...
  <script src="../js/script_empleado_instituto.js"></script>
...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="presentacion">
            <h1>Panel de Administración de Empleados por Instituto</h1>
        </div>
        
        <div id="leer">
            <h3>Lista de Empleados por Instituto</h3>
            <div class="refresh">
    ...
    <div id="eliminar">
        ...
        <form>
            <div class="form-group">  
                ...
                <h3>Eliminar Empleado por Instituto</h3>
