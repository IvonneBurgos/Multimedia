...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="presentacion">
            <h1>Panel de Administración de Subtipo Examen de Laboratorio</h1>
        </div>
        
        <div id="leer">
            <h3>Lista de Subtipos Examen de Laboratorio</h3>
            <div class="refresh">
    ...
    <div id="eliminar">
        ...
        <form>
            <div class="form-group">  
                ...
                <h3>Eliminar Subtipo Examen de Laboratorio</h3>
