...
<head>
 ...
 <link rel="stylesheet" href="../css/style.css" type="text/css"/>     
  ...
  <script src="../js/script_tipo_examen_laboratorio.js"></script>
...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="insertar">
            ...
            <form>
                <div class="form-group">    
                    <h3>Ingresar nuevo Tipo Examen Laboratorio</h3>
                    <br>
                    <label>Nombre:</label><br>
                    <input id="nombre_tipo_examen_laboratorio" class="form-control" type="text" name="nombre"><br>
                </div>
            </form>
        ...
        <div id="presentacion">
            <h1>Panel de Administración de Tipos Examenes Laboratorio</h1>
        </div>
        
        <div id="leer">
            <h3>Lista de Tipos Examenes Laboratorio</h3>
            <div class="refresh">
        ...
        <div id="modificar">
            ...
            <form>
                <div class="form-group">   
                    <h3>Modificar Tipo Examen Laboratorio</h3>
                    <br>
                    <label>Id:</label><br>
    ...
    <div id="eliminar">
        ...
        <form>
            <div class="form-group">  
                ...
                <h3>Eliminar Tipo Examen Laboratorio</h3>
                ...
                <div class="col-sm-5 text-left"> 
                    ...
                    <select id='eliminaNombreTipoExamenLaboratorio' class="form-control"></select><br>
                    ...
                    <select id='eliminaIdTipoExamenLaboratorio' class="form-control"></select><br>
