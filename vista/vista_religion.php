...
<head>
 ...
 <link rel="stylesheet" href="../css/style.css" type="text/css"/>     
  ...
  <script src="../js/script_religion.js"></script>
...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="insertar">
            ...
            <form>
                <div class="form-group">    
                    <h3>Ingresar nueva Religión</h3>
                    <br>
                    <label>Nombre:</label><br>
                    <input id="nombre_religion" class="form-control" type="text" name="nombre">
                </div>
            </form>
        ...
        <div id="presentacion">
            <h1>Panel de Administración de Religión</h1>
        </div>
        
        <div id="leer">
            <h3>Lista de Religiones</h3>
            <div class="refresh">
