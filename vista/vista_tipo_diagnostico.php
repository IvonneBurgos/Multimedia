...
<head>
 ...
 <link rel="stylesheet" href="../css/style.css" type="text/css"/>     
  ...
  <script src="../js/script_tipo_diagnostico.js"></script>
...
<div class="container-fluid text-center">
  <div class="row content">
    <div id="contenedor" class="col-sm-10 text-left">
        ...
        <div id="insertar">
            ...
            <form>
                <div class="form-group">    
                    <h3>Ingresar nuevo Tipo Diagnóstico</h3>
                    <br>
                    <label>Nombre:</label><br>
                    <input id="nombre_tipo_diagnostico" class="form-control" type="text" name="nombre"><br>               
                </div>
            </form>
        ...
        <div id="leer">
            <h3>Lista de Tipos Diagnóstico</h3>
            <div class="refresh">
    ...
    <div id="eliminar">
        ...
        <form>
            <div class="form-group">  
                ...
                <h3>Eliminar Tipo Diagnóstico</h3>
