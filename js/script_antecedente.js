$(document).ready(function(){
    ...
    $("#enviarInsert").click(function(){
        ...
        $.post("../controlador/antecedente/controlador_antecedente_insertar.php", {provincia: $('#insertar #nombre_provincia_ciudad').val(), nombre: $('#insertar #nombre_antecedente').val()}, function(resp){
    ...
    $("#enviarUpdate").click(function(){
        ...
        $.post("../controlador/antecedente/controlador_antecedente_modificar.php",{id: $('#modificar #idModificar').val(), provincia: $('#modificar #nombre_provincia_ciudad_modificar').val(), nombre: $('#modificar #nombre_antecedente').val(), estado: $('#estadoModificar option:selected').text()}, function(resp){
    ...
    $("#enviarNombre").click(function(){
        ...
        $.post("../controlador/antecedente/controlador_antecedente_eliminar_nombre.php",{provincia: $('#eliminar #eliminaNombreProvincia').val(), nombre: $('#eliminar #eliminaNombreAntecedente').val()}, function(resp){
    ...
    $("#enviarId").click(function(){
        $("#eliminar #resultado2").empty();
        $.post("../controlador/antecedente/controlador_antecedente_eliminar_id.php",{id: $('#eliminar #eliminaIdCiudad').val()}, function(resp){
...
function cargarListas(){
    ...
    $.post("../controlador/antecedente/controlador_antecedente_consultar.php", function(resp){
        var parse = JSON.parse(resp);
        for(var x=0 ; x < (parse.listaopciones.length-1); x++){
            $("#eliminaNombreAntecedente").append( '<option value="'+parse.listaopciones[x].nombre+ '">'+parse.listaopciones[x].nombre+' </option>');
    ...
    $.post("../controlador/provincia/controlador_provincia_consultar.php", function(resp3){
        var parse3 = JSON.parse(resp3);
        for(var z=0; z < (parse3.listaopciones.length-1); z++){
            $("#eliminaNombreProvincia").append( '<option value="'+parse3.listaopciones[z].nombre+ '">'+parse3.listaopciones[z].nombre+' </option>');
            $("#nombre_provincia_ciudad").append( '<option value="'+parse3.listaopciones[z].nombre + '">'+parse3.listaopciones[z].nombre+' </option>');
            //console.log(parse2.listaopciones[y].nombre);
            $("#nombre_provincia_ciudad_modificar").append( '<option value="'+parse3.listaopciones[z].id + '">'+parse3.listaopciones[z].id+' </option>');
            //console.log(parse2.listaopciones[y].nombre);
        };
