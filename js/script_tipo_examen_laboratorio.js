$(document).ready(function(){
    ...
    $("#enviarId").click(function(){
        $.post("../controlador/tipo_examen_laboratorio/controlador_tipo_examen_laboratorio_eliminar_id.php",{id: $('#eliminar #eliminaIdTipoExamenLaboratorio').val()}, function(resp){
...
function refrescar(){
    $.post("../controlador/tipo_examen_laboratorio/controlador_tipo_examen_laboratorio_consultar.php", function(resp){
   //console.log(resp);
...
function cargarListas(){
    $('#eliminaNombreTipoExamenLaboratorio')
    .empty();
    $('#eliminaIdTipoExamenLaboratorio')
    .empty();
    $('#idModificar')
    .empty();
    ...
    $.post("../controlador/tipo_examen_laboratorio/controlador_tipo_examen_laboratorio_consultar.php", function(resp){
        var parse = JSON.parse(resp);
        for(var x=0 ; x < (parse.listaopciones.length-1); x++){
            $("#eliminaNombreTipoExamenLaboratorio").append( '<option value="'+parse.listaopciones[x].nombre+ '">'+parse.listaopciones[x].nombre+' </option>');
            $("#eliminaIdTipoExamenLaboratorio").append( '<option value="'+parse.listaopciones[x].id+ '">'+parse.listaopciones[x].id+' </option>');
