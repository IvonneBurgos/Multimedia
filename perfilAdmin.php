    ...
    <div class="col-sm-12">
        ...
        <div class="col-md-12">
            <h3>Seguridad de Administración</h3>
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Opción</p>
                    <a href="vista/vista_opcion.php" class="icono"><i class="fa fa-list-alt fa-4x"></i></a>
                </div>
                 <div class="col-md-2 col-sm-6 col-xs-6">
       ...
       <div class="col-md-12">
            <h3>Persona</h3>
                ...
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Usuario</p>
                    <a href="vista/vista_usuario.php" class="icono"><i class="fa fa-user fa-4x"></i></a>
                </div>
                 <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Paciente</p>
                    <a href="vista/vista_paciente.php" class="icono"><i class="fa fa-hotel fa-4x"></i></a>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Dirección</p>
                    <a href="vista/vista_direccion.php" class="icono"><i class="fa fa-building fa-4x"></i></a>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Teléfono</p>
                    <a href="vista/vista_telefono.php" class="icono"><i class="fa fa-phone fa-4x"></i></a>
                </div>  
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Etnia</p>
            ...
            <h3>Información Médica</h3>
               ...
               <div class="col-md-2 col-sm-6 col-xs-6">
                ...
                <div class="col-md-2 col-sm-6 col-xs-6">
                    ...
                    <a href="vista/vista_subtipo_examen_laboratorio.php" class="icono"><i class="fa fa-file-text-o fa-4x"></i></a>
                </div>          
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Tipo Antecedente</p>
                    <a href="vista/vista_tipo_antecedente.php" class="icono"><i class="fa fa-files-o fa-4x"></i></a>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-6">
                ...
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Antecedente</p>
                    <a href="vista/vista_antecedente.php" class="icono"><i class="fa fa-tags fa-4x"></i></a>
                </div>       
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Etiqueta Antecedente</p>
                    <a href="vista/vista_etiqueta_antecedente.php" class="icono"><i class="fa fa-tags fa-4x"></i></a>
                </div> 
                <div class="col-md-2 col-sm-6 col-xs-6">
                    <p>Composición</p>
